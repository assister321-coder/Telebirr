...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  @NonNull
  public final View patternOverlay;

  @NonNull
  public final TextView tvLogo;

  private ActivitySplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull FrameLayout loadingContainer, @NonNull LinearLayout logoContainer,
      @NonNull View patternOverlay, @NonNull TextView tvLogo) {
    this.rootView = rootView;
    this.loadingContainer = loadingContainer;
    this.logoContainer = logoContainer;
    this.patternOverlay = patternOverlay;
    this.tvLogo = tvLogo;
  }
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.patternOverlay;
      View patternOverlay = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, loadingContainer, logoContainer,
          patternOverlay, tvLogo);
    }
