...
public final class ItemServiceBinding implements ViewBinding {
  ...
  private ItemServiceBinding(@NonNull LinearLayout rootView, @NonNull View iconBg,
      @NonNull TextView iconView, @NonNull ImageView ivIcon, @NonNull TextView tvServiceName) {
  ...
  public static ItemServiceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemServiceBinding((LinearLayout) rootView, iconBg, iconView, ivIcon,
          tvServiceName);
    }
